...
class Regression:
    def __init__(self,
        ...
        if phys_model == 'newns_anderson_semi':
            ...
            if task == 'train':
                target = np.zeros((len(energy),9+3*num_datapoints))
            elif task == 'test':
                target = energy
        ...
        if phys_model == 'newns_anderson_semi':
            ...
            if task =='train':
                d_cen_1 = torch.from_numpy(d_cen_1).type(torch.FloatTensor)
                d_cen_2 = torch.from_numpy(d_cen_2).type(torch.FloatTensor)
                d_cen_3 = torch.from_numpy(d_cen_3).type(torch.FloatTensor)
                d_cen_4 = torch.from_numpy(d_cen_4).type(torch.FloatTensor)
                width_1 = torch.from_numpy(width_1).type(torch.FloatTensor)
                width_2 = torch.from_numpy(width_2).type(torch.FloatTensor)
                width_3 = torch.from_numpy(width_3).type(torch.FloatTensor)
                width_4 = torch.from_numpy(width_4).type(torch.FloatTensor)
                ...
                if cuda:
                    d_cen_1 = d_cen_1.cuda()
                    d_cen_2 = d_cen_2.cuda()
                    d_cen_3 = d_cen_3.cuda()
                    d_cen_4 = d_cen_4.cuda()
                    width_1 = width_1.cuda()
                    width_2 = width_2.cuda()
                    width_3 = width_3.cuda()
                    width_4 = width_4.cuda()
                    dos_ads_1 = dos_ads_1.cuda()
                    dos_ads_2 = dos_ads_2.cuda()
                    dos_ads_3 = dos_ads_3.cuda()
                
                self.d_cen_1 = d_cen_1
                self.d_cen_2 = d_cen_2
                self.d_cen_3 = d_cen_3
                self.d_cen_4 = d_cen_4
