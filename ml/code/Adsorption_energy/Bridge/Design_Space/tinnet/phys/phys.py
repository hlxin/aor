...
class Chemisorption:
    ...
    def newns_anderson_semi(self, namodel_in, model, task , **kwargs):
        ...
        alpha = 0.044063819308038064
        d_cen_1 = namodel_in[:,9]
        d_cen_2 = namodel_in[:,10]
        width_1 = torch.nn.functional.softplus(namodel_in[:,11])
        width_2 = torch.nn.functional.softplus(namodel_in[:,12])
