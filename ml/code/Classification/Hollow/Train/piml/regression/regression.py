...
class Regression:
    def __init__(self,
        ...
        self.best_mae_error = best_mae_error
        self.best_counter = 0
    ...
    def train(self, epochs=10, **kwargs):
        for epoch in range(self.start_epoch, self.start_epoch + epochs):
            ...
            is_best = val_mae > self.best_mae_error
            self.best_mae_error = max(val_mae, self.best_mae_error)
            ...
            if self.best_counter >= 1000:
                ...
                return self.best_val_mse, self.best_val_mae,\
